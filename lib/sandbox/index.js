 ...
 */
export function createSandboxedTools(cwd, customTools, { agentDir, workspace, workspaceFolders = [], hanakoHome, getSandboxEnabled, getExternalReadPaths }) {
  ...
  if (checkAvailability(platform)) {
    const sandboxExec = platform === "seatbelt"
      ...
      : createBwrapExec(policy, { getExternalReadPaths });
