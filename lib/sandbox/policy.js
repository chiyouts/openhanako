...
export const READ_WRITE_HOME_DIRS = ["channels", "logs", "uploads", "session-files"];
 ...
 */
export function deriveSandboxPolicy({ agentDir, workspace, workspaceFolders = [], hanakoHome, mode, extraReadOnlyPaths = [] }) {
  if (mode === "full-access") {
